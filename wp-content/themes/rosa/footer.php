...
if ( ! is_404() ):
	...
	<footer class="site-footer <?php echo $footer_needs_big_waves === true ? 'border-waves' : '' ?>">
		...
		<div class="copyright-area <?php echo $footer_bottom_bar_style ?>">
            ...
            <span>Buffalo Republic   •   Carrera 23 # 75 111 Milán. Manizales, Colombia   •   Tel: 8868027   •   Email: buffalorepublic@gmail.com</span>
		</div>
		<!-- .copyright-area -->
	</footer><!-- .site--footer -->
...
<script type="text/javascript" src="/public/js/map.js?ver=ss"></script>
