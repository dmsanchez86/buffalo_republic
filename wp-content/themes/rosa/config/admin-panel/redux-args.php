...
return array(
	...
	'intro_text'            => __( '<h4>Theme Options</h4><p>These allow you to adjust the overall settings for your website.</p>', 'rosa_txtd' ),
	// add content after the form
	//'footer_text' => __('<p>This text is displayed below the options panel. It isn\'t required, but more info is always better! The footer_text field accepts all HTML.</p>', 'rosa_txtd'),

	// set footer/credit line
	//'footer_credit' => __('<p>This text is displayed in the options panel footer across from the WordPress version (where it normally says \'Thank you for creating with WordPress\'). This field accepts all HTML.</p>', 'rosa_txtd'),

	// setup custom links in the footer for share icons
	'share_icons'           => array(
		'twitter'   => array(
			'link'  => 'http://twitter.com/pixelgrade',
			'title' => __( 'Follow us on Twitter', 'rosa_txtd' ),
		...
		'linked_in' => array(
			...
			'title' => __( 'Find us on LinkedIn', 'rosa_txtd' ),
		...
		'facebook'  => array(
			...
			'title' => __( 'Find us on Facebook', 'rosa_txtd' ),
	...
	'menu_title'            => __( 'Theme Options', 'rosa_txtd' ),
	# default: Options

	// Set a custom page title for the options page.
	'page_title'            => __( 'Options', 'rosa_txtd' ),
	# default: Options
	...
	//				(
	//					'id' => 'redux-opts-1',
	//					'title' => __('Theme Information 1', 'rosa_txtd'),
	//					'content' => __('<p>This is the tab content, HTML is allowed.</p>', 'rosa_txtd')
	//				),
	//				array
	//				(
	//					'id' => 'redux-opts-2',
	//					'title' => __('Theme Information 2', 'rosa_txtd'),
	//					'content' => __('<p>This is the tab content, HTML is allowed.</p>', 'rosa_txtd')
	//				)
	//			),

	// Set the help sidebar for the options page.
	// 'help_sidebar' => __('<p>This is the sidebar content, HTML is allowed.</p>', 'rosa_txtd'),
	'hints'                 => array(
